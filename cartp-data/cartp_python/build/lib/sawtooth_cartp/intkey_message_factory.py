...
from sawtooth_cartp.processor.handler import CARTP_ADDRESS_PREFIX
from sawtooth_cartp.processor.handler import make_cartp_address


class cartpMessageFactory:
    def __init__(self, signer=None):
        self._factory = MessageFactory(
            family_name='cartp',
            family_version='1.0',
            namespace=CARTP_ADDRESS_PREFIX,
            signer=signer)
    ...
    def _create_txn(self, txn_function, verb, name, value):
        ...
        addresses = [make_cartp_address(name)]
    ...
    def create_get_response(self, name, value):
        address = make_cartp_address(name)
